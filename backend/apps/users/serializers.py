...
class UserCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'role', 'first_name', 'last_name', 'phone', 'is_active', 'is_online', 'profile_photo', 'password', 'faculty_profile', 'hod_profile', 'iqac_profile']
        read_only_fields = ['id']
    ...
    def create(self, validated_data):
        ...
        if password:
            ...
            # Safer default if none provided: sece@123
