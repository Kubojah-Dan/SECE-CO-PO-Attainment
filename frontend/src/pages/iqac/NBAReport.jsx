        ...
        <Card className="border border-gray-200 bg-white">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h2 className="text-5xl font-black text-slate-900 mt-2">{readinessData?.overall_readiness || 0}%</h2>
              <p className="text-slate-400 text-xs mt-4">Based on current cycle data uploads.</p>
            </div>
            ...
            <div className="flex items-start justify-between gap-6">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <span className={`px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-widest ${section.status === 'Complete' ? 'bg-emerald-50 text-emerald-600' :
